    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    <h2><i class="fa fa-file-o"></i> <strong>Employee</strong> Info</h2>
                </div>
                ...
                <div class="block-section text-center">
                    ...
                    <h3>
                        <strong><?php if(!empty($employee)) echo $employee->name; ?></strong><br><small></small>
                    </h3>
                    <input type="hidden" id="emp_id" value="<?php if(!empty($employee)) echo $employee->id; ?>">
                </div>
                <table class="table table-borderless table-striped table-vcenter">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php if(!empty($employee)) echo $employee->phone_number; ?></td>
                        </tr>
                        <tr>
                            <td class="text-right"><strong>Address</strong></td>
                            <td><?php if(!empty($employee)) echo $employee->address; ?></td>
                        </tr>
                        <tr>
        ...
        <div class="col-lg-8">
                    ...
                    <table id="advance-datatable" class="table table-vcenter table-condensed table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width: 30%;"><?php if(!empty($employee)) echo $employee->name.' Advance'; ?></td>
            ...
            <div class="block">
                ...
                <div class="block-title">
                    <h2><i class="fa fa-mobile"></i> <strong>Sales</strong> By Employee</h2>
                </div>
                ...
                <div class="table-responsive">
                    <table id="sales-datatable" class="table table-vcenter table-condensed table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center" style="width: 10%;"><?php echo $i; ?></td>
                                <td class="text-capitalize" style="width: 30%;"><?php echo $sale['description']; ?></td>
                                <td class="text-right"><strong class="text-success">₹ <?php echo $sale['amount']; ?></strong></td>
                                <td><?php echo date('d-m-Y h:i a', strtotime($sale['date_added'])); ?></td>
                            </tr>
                            <?php
                            $i++;
                                }
            ...
            <div class="modal-body">
                <form action="<?php echo base_url('admin/insert_advance_data'); ?>" id="income-validation" method="post" class="form-horizontal form-bordered">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="hidden" id="old_user_id" name="old_user_id" value="<?php if(!empty($employee)) echo $employee->id; ?>">
                            <p class="form-control-static"><?php if(!empty($employee)) echo $employee->name; ?></p>
                        </div>
                    </div>
                    <div class="form-group">
